...
public class GeneradorFormularioFactory {
    ...
    private static PDFont fuenteBasicaNegritaInclinada = PDType1Font.HELVETICA_BOLD_OBLIQUE;
    private static PDFont fuenteBasicaInclinada = PDType1Font.HELVETICA_OBLIQUE;
    ...
    public static void crearTipoCredito(
            SolicitudCreditoViviendaDTO solicitudDTO,
            PDPageContentStream contentStream) throws IOException {

        new Grid((int) maxX, (int) maxY).draw(contentStream);
    ...
    public static void crearTipoGarantia(
            SolicitudCreditoViviendaDTO solicitudDTO,
            PDPageContentStream contentStream) throws IOException {
    ...
    public static void crearMontoPrestamoSolicitado(
            SolicitudCreditoViviendaDTO solicitudDTO,
            PDPageContentStream contentStream) throws IOException {
        ...
        Style fuenteEstrechaInclinada = Style.builder()
                .addTextFont(fuenteBasicaInclinada)
                .addFontSize(9f)
                .addTextColor(Color.BLACK)
                .addLeading(0.8f)
                .build();
        ...
        Column column1 = EasyComponentsFactory.getSimpleColumnFromTextAndWidthsAndStylesAndRelativePosition(
                ...
                Arrays.asList(25f,30f,80f,50f,70f,130f,105f),
                Arrays.asList(
                        fuenteEstrecha,
                        fuenteEstrecha,
    ...
    public static void crearDatosSolicitado(
            SolicitudCreditoViviendaDTO solicitudDTO,
            PDPageContentStream contentStream) throws IOException {
        float initX  = marginStartX+thickness;
        float witdh = 500f;
...
/*
        Cell celdaCuerpo = EasyComponentsFactory.getSimpleCell(5f, 5, true,
                EasyComponentsFactory.getSimpleTable(0, 0, column1)
        );
...
*/
        ...
        SimpleTable tabla = EasyComponentsFactory.getSimpleTable(initX, maxY - 395, columnTitulo /*,cuerpo*/);
        tabla.draw(contentStream);
